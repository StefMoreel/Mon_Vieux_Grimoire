...
router.put('/:id', auth, multer, sharp, validateBookUpdate, uploadToCloudinary, dataCtrl.updateBook); // Protected route to update a book
router.post('/', auth, multer, validateBook, sharp, uploadToCloudinary, (req, res, next) => {
