...
router.put('/:id', auth, multer, sharp, dataCtrl.updateBook); // Protected route to update a book
router.post('/', auth, validateBook, multer, sharp, dataCtrl.createBook); // Protected route to create a new book with image upload
