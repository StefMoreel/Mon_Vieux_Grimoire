...
router.put('/:id', auth, upload, validateBookUpdate, uploadToCloudinary, dataCtrl.updateBook); // Protected route to update a book
router.post('/', auth, upload, validateBook, uploadToCloudinary, (req, res, next) => {
